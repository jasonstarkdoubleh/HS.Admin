<template>
  <div class="container" id="menuFirst"
       :style="{width:'99%',marginTop: '-25px',height:clientHeight}">
    <el-scrollbar style="height: 100%;">
      ...
      <el-table :data="tableTreeDdata"
        ...
        <el-table-column prop="urladdress"
                         header-align="center"
                         align="center"
                         width="150"
        ...
        <el-table-column prop="enabledmark"
                         header-align="center"
                         align="center"
                         width="150"
                         :show-overflow-tooltip="true"
        ...
        <el-table-column fixed="right"
          ...
          <template slot-scope="scope">
            <kt-button label="修改"
                       perms="back:menu:update"
                       @click="handleEdit(scope.row)" />
            <kt-button label="删除"
                       perms="back:menu:delete"
                       type="danger"
      ...
      store
        ...
        .then(res => {
         ...
         const treen= treeUtils(res)
          this.tableTreeDdata = treen;
         // console.log(this.tableTreeDdata);
          // this.popupTreeData = this.getParentMenuTree(treen);
          this.loading = false;
        })
        .catch(error => {
          console.log(error);
