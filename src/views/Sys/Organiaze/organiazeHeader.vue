<template>
  <div id="tableheader">
    ...
    <el-dialog title="添加机构" :visible.sync="dialogFormVisible" width="600px" class="editFormOrg">
    ...
    <el-dialog title="编辑机构" :visible.sync="dialogEditVisible" width="600px" class="editFormOrg">
      <el-form :model="formEdit" :inline="true" size="mini">
  ...
  export default {
        ...
        addCompany:function () {
          this.$refs['form'].validate((valid) => {
            if (valid) {
              ...
              this.$api.dic.saveOrganize(this.form).then(() => {
                for(let key in this.form){
                  this.form[key] = ''
                }
                for(let i in this.areaAddress){
                  this.areaAddress[i] = ''
                }
                this.addre = '';
                this.current.organizeid = '';
                this.upcompany = '';
                this.manager= '';
                this.nature='';
                this.timeValue='';
      ...
      computed:{
        ...
        areaAddress:function () {
          return this.$store.getters.addressy;
        },
        orglist2:function () {
